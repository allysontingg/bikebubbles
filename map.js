...
mapboxgl.accessToken = 'pk.eyJ1IjoiYWxseXNvbnRpbmdnIiwiYSI6ImNtYXNvc3d1NzBwMHgyam9oYmIwaHNseGUifQ.DMB4cULznW-UGlrmdZGwpw';
...
map.on('load', async () => {
    ...
    const circles = svg
        ...
        .attr('stroke-opacity', 0.6) // Circle border opacity
    ...
    function updateTimeDisplay() {
        ...
        if (timeFilter === -1) {
            ...
            anyTimeLabel.style.display = 'flex'; // Show "(any time)"
        } else {
